                ...
                <div class="collapse show" id="collapseCardExample2">
                    <div class="card-body">
                        ...
                        <form:form action="${ pageContext.request.contextPath }/settings/bank"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close" id="dismissDialogBtn">
                            ...
                            <button type="submit"
                                    class="btn btn-primary btn-user btn-block btn-lg">Update
                            </button>

                            <div class="alert alert-success mt-4" id="alert" role="alert" style="display:none;">ADDED
                                SUCCESSFULLY!
                            </div>
                        </form:form>
...
<script>
$('#rechargeMoneyBtn').on('click', function () {
  rechargeMoney();
});


function rechargeMoney () {
  $.post("/api/v1/recharge-money", {
    amount: document.getElementById("amountValue").value,
  }, function (data, status) {

    console.log(data);

    $('#currentBalanceId').val(data.currentBalance);

    // hide the modal
    setTimeout(function () {
      $('#rechargeModalCenter').click();
      $('#rechargeModalCenter').click();
    }, 200);
