package com.bs23.esmpanel.config.persistence;
...
@EnableJpaRepositories("com.bs23.esmpanel.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                Properties settings = getBuiltProperties("hibernate-dev.properties");

                configuration.setProperties(settings);
                configuration.addPackage("com.bs23.esmpanel.model");
                for (Class<?> clazz : (new Reflections("com.bs23.esmpanel.model")).getTypesAnnotatedWith(Entity.class)) {
